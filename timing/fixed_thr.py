...
def fixed_thr(signal_window, valid, max_idx, values_max, **kwargs):
  ...
  return {"time": timing.pseudo_t(rise_valid, valid, thresholds, sampling_rate, interpolation_factor, max_idx, rise_interp_left_samples, rise_interp_right_samples, rise_samples_pre_peak, thr_tol=timing_thr_tol)}
